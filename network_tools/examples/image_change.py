...
for stream_result in client.change_image_api(
        ...
        inpaint_models=[ImageModels.nano_banana_pro]
):
    print("Изменённое изображение:", stream_result)

# # Изменение изображения (inpaint) (legacy)
# for stream_result in client.change_image_api(
#         model=ImageChangeModels.inpaint,
#         image_path=image_path,
...
# # Добавить текст (только английские буквы) (legacy)
# for stream_result in client.change_image_api(
...
# # Изображение с таким же стилем (legacy)
# result = client.change_image_api(
...
# # Найти и заменить объект на картинке (legacy)
# result = client.change_image_api(
